            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box bg-white">
                    <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                        ...
                        <Link onClick="/" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2"
                        >
                            ✕
                        </Link>
                    ...
                    <div className='flex justify-around mt-4'>
                        <button className='px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-700 duration-200'>Login</button>
