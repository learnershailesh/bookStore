  ...
  return (
    ...
    <>
      ...
      <div  className="w-[600px]">
                <div className="modal-box bg-white border-[2px] shadow-md p-5 rounded-3xl">
                    ...
                    <div className='flex justify-around mt-4'>
                        <button className='px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-700 duration-200'>Signup</button>
                        <p> Have an account? {" "} <Link to="/login" className='underline text-blue-500 cursor-pointer'
